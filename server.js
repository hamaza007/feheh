...
client.on("message", message => {
  if (message.content.toLowerCase() === prefix + "help") {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .addField(
        `General`,
        `> **${prefix}user ${prefix}server ${prefix}avatar ${prefix}server avatar ${prefix}roles ${prefix}emojis ${prefix}ping ${prefix}find ${prefix}discrim ${prefix}roll**`,
        true
      )
      .addField(
        `Moderation`,
        `> **${prefix}kick ${prefix}ban ${prefix}mute ${prefix}unmute ${prefix}lock ${prefix}unlock ${prefix}clear ${prefix}nick ${prefix}role ${prefix}vkick ${prefix}vmute/unmute ${prefix}move ${prefix}set-stayvoice ${prefix}stayvoice ${prefix}help limts**`,
        true
      )
      .addField(
        `Ticket`,
